...
To install Auto Announcements, you can use an executable package (Windows), run the scripts through Python (Windows, macOS, Linux), install from the [Python Package Index](https://pypi.org/), or run a [Docker](https://www.docker.com/) container from [GitHub Packages](https://github.com/willtheorangeguy/Auto-Anouncements/pkgs/container/auto-anouncements). To customize the program to your needs, see [`CUSTOMIZATION`](CUSTOMIZATION.md).
